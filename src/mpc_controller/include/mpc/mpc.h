...
private:
    ...
    ros::Publisher pos_cmd_pub_, vis_pub, predict_pub, ref_pub, error_pub, test_pub,cmd_pub_,
    px_pub_,py_pub_,yaw_pub_,vel_pub_; 
    ...
    void rcvTrajCallBack(mpc_controller::PolynomeConstPtr msg);
    void rcvMincoCallBack(mpc_controller::MincoTrajConstPtr msg);
    void rcvDPCallBack(mpc_controller::DPtrajContainerConstPtr msg);
